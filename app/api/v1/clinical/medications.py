...
async def create_medication(data: MedicationCreate, db: Session = Depends(get_db), _=Depends(require_permission(Permission.WRITE_REFERENCE))):
...
async def list_medications(skip: int = 0, limit: int = 100, db: Session = Depends(get_db), _=Depends(require_permission(Permission.READ_REFERENCE))):
    service = MedicationService(db)
...
async def get_medication(medication_id: int, db: Session = Depends(get_db), _=Depends(require_permission(Permission.READ_REFERENCE))):
    service = MedicationService(db)
...
async def update_medication(medication_id: int, data: MedicationUpdate, db: Session = Depends(get_db), _=Depends(require_permission(Permission.WRITE_REFERENCE))):
    service = MedicationService(db)
...
async def delete_medication(medication_id: int, db: Session = Depends(get_db), _=Depends(require_permission(Permission.WRITE_REFERENCE))):
    service = MedicationService(db)
...
async def create_prescription(consultation_uuid: UUID, data: PrescriptionCreate, db: Session = Depends(get_db), _=Depends(require_permission(Permission.WRITE_REFERENCE))):
    service = MedicationService(db)
...
async def list_prescriptions(consultation_uuid: UUID, db: Session = Depends(get_db), _=Depends(require_permission(Permission.READ_REFERENCE))):
    service = MedicationService(db)
...
async def get_prescription(prescription_uuid: UUID, db: Session = Depends(get_db), _=Depends(require_permission(Permission.READ_REFERENCE))):
    service = MedicationService(db)
...
async def delete_prescription(prescription_uuid: UUID, db: Session = Depends(get_db), _=Depends(require_permission(Permission.WRITE_REFERENCE))):
    service = MedicationService(db)
