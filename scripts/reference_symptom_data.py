...
# ─── SUPPLEMENT: 64 variant/subtype/unspecified disorders ───
    ...
    "Deficiência Intelectual Grave": [
        ("intellectual_function_deficit", "Déficit em funções intelectuais (raciocínio, solução de problemas, planejamento, pensamento abstrato)", True, 0),
        ("adaptive_functioning_deficit", "Déficit no funcionamento adaptativo (comunicação, participação social, vida independente)", True, 0),
        ("developmental_onset", "Início dos déficits durante o período do desenvolvimento", True, 0),
        ("social_adaptive_deficit", "Comprometimento do funcionamento social ou adaptativo sem suporte", False, 0),
    ],
    ...
    "Disforia de Gênero Não Especificada": [
        ("gender_incongruence", "Incongruência clinicamente significativa entre o gênero experienciado/expresso e o gênero designado, por pelo menos 6 meses", True, 180),
        ("cross_gender_preferences", "Preferências marcantes por brincadeiras, atividades ou papéis associados ao outro gênero", False, 0),
        ("aversion_sex_characteristics", "Aversão intensa às características sexuais primárias ou secundárias", False, 0),
        ("desire_be_other_gender", "Desejo intenso de ser do outro gênero", False, 0),
        ("preference_other_gender_peers", "Preferência por pares do outro gênero", False, 0),
    ],
    "Disfunção Sexual Induzida por Substância": [
        ("delayed_ejaculation", "Atraso acentuado, infrequência ou ausência de ejaculação durante a atividade sexual, atribuível a substância", True, 180),
        ("delayed_ejaculation_frequency", "Ocorre em aproximadamente 75-100% das oportunidades sexuais", False, 180),
        ("delayed_ejaculation_duration", "Persiste por no mínimo 6 meses", False, 180),
    ],
    "Disfunção Sexual Não Especificada": [
        ("delayed_ejaculation", "Atraso acentuado, infrequência ou ausência de ejaculação durante a atividade sexual", True, 180),
        ("delayed_ejaculation_frequency", "Ocorre em aproximadamente 75-100% das oportunidades sexuais", False, 180),
        ("delayed_ejaculation_duration", "Persiste por no mínimo 6 meses", False, 180),
    ],
    ...
    "Outro Transtorno Alimentar Especificado": [
        ("non_nutritive_ingestion", "Ingestão persistente de substâncias não nutritivas e não alimentares por pelo menos 1 mês", True, 30),
        ("pica_one_month", "Comportamento presente por pelo menos 1 mês", False, 30),
        ("not_cultural_practice", "O comportamento não é parte de uma prática culturalmente sancionada", False, 0),
    ],
    "Outro Transtorno Bipolar Especificado": [
        ("hypomanic_subclinical", "Múltiplos períodos de sintomas hipomaníacos subclínicos que não preenchem critérios completos para episódio hipomaníaco", True, 720),
        ("depressive_subclinical", "Múltiplos períodos de sintomas depressivos subclínicos que não preenchem critérios completos para episódio depressivo maior", True, 720),
        ("cyclothymic_two_years", "Sintomas presentes por 2+ anos (1 ano em crianças/adolescentes)", False, 720),
        ("no_major_mood_episode", "Ausência de episódio maníaco, hipomaníaco ou depressivo maior", False, 0),
    ],
    "Outro Transtorno Depressivo Especificado": [
        ("temper_outbursts_severe", "Explosões de raiva severas e recorrentes (verbais e/ou comportamentais) desproporcionais em intensidade e duração", True, 365),
        ("irritable_mood_persistent", "Humor irritável ou raivoso persistente entre as explosões", True, 365),
        ("outburst_frequency_3x_week", "As explosões ocorrem em média 3+ vezes por semana", False, 365),
        ("outbursts_multiple_settings", "As explosões ocorrem em pelo menos 2 ambientes (casa, escola, comunidade)", False, 0),
        ("dmd_onset_before_10", "O diagnóstico não deve ser feito pela primeira vez antes dos 6 ou após os 18 anos", False, 0),
    ],
    "Outro Transtorno Disruptivo Especificado": [
        ("angry_irritable_mood", "Humor raivoso/irritável, comportamento questionador/desafiante ou índole vingativa por 6+ meses", True, 180),
        ("argumentative_defiant", "Frequentemente questiona figuras de autoridade ou recusa cumprir regras", False, 180),
        ("vindictiveness", "Índole vingativa (malicioso, vingativo) por pelo menos 2 vezes nos últimos 6 meses", False, 180),
        ("odd_behavior_6_months", "Comportamento persistente por pelo menos 6 meses", False, 180),
    ],
    "Outro Transtorno Dissociativo Especificado": [
        ("identity_disruption", "Perturbação da identidade caracterizada por dois ou mais estados de personalidade distintos", True, 0),
        ("memory_gaps_daily", "Lacunas recorrentes na memória para eventos cotidianos ou informações pessoais", True, 0),
        ("autobiographical_amnesia", "Incapacidade de recordar informações autobiográficas importantes que não é consistente com esquecimento comum", False, 0),
        ("depersonalization", "Experiências de dessensação, despersonalização ou sensação de irrealidade", False, 0),
        ("dissociative_flashbacks", "Flashbacks dissociativos nos quais o paciente revive o evento traumático", False, 0),
    ],
    "Outro Transtorno Mental Especificado": [
        ("distress_impairment_symptoms", "Sintomas característicos de transtorno mental que causam sofrimento ou prejuízo clinicamente significativo, mas não preenchem todos os critérios para nenhum transtorno específico", True, 0),
        ("clinician_specifies_reason", "O clínico opta por especificar a razão pela qual os critérios não são totalmente preenchidos", False, 0),
        ("exclude_primary_disorder", "Os sintomas não são mais bem explicados por outro transtorno mental", False, 0),
    ],
    "Outro Transtorno Neurocognitivo Especificado": [
        ("cognitive_decline_significant", "Declínio cognitivo significativo em um ou mais domínios (complexa atenção, função executiva, aprendizado, memória, linguagem, perceptual-motor, cognição social)", True, 0),
        ("daily_activity_dependence", "O declínio interfere na independência em atividades diárias", True, 0),
        ("cognitive_concern", "Preocupação com declínio cognitivo relatada pelo paciente ou informante", False, 0),
        ("not_during_delirium", "O declínio não ocorre exclusivamente durante delirium", False, 0),
    ],
    "Outro Transtorno Obsessivo-Compulsivo Especificado": [
        ("body_defect_preoccupation", "Preocupação com um ou mais defeitos ou falhas percebidas na aparência física que não são observáveis por outros", True, 0),
        ("appearance_checking", "Comportamentos repetitivos de verificação da aparência em espelhos ou superfícies", False, 0),
        ("appearance_avoidance", "Esquiva de situações que exponham a aparência física", False, 0),
        ("appearance_repetitive_behaviors", "Comportamentos mentais repetitivos (comparação com outros, busca por tranquilização)", False, 0),
    ],
    "Outro Transtorno Parafílico Especificado": [
        ("voyeuristic_arousal", "Excitação sexual intensa e recorrente ao observar pessoa não suspeita nua ou em atividade sexual", True, 0),
        ("voyeuristic_6_months", "Presente por 6+ meses", True, 180),
        ("voyeuristic_distress", "O desejo ou comportamento causa sofrimento ou comprometimento clinicamente significativo", False, 0),
        ("voyeuristic_action", "A pessoa agiu de acordo com o desejo ou o desejo causa sofrimento significativo", False, 0),
    ],
    "Outro Transtorno Relacionado a Trauma Especificado": [
        ("traumatic_exposure_acute", "Exposição a morte real ou ameaça, lesão grave ou violência sexual de forma direta, testemunhada ou indireta", True, 0),
        ("acute_intrusion", "Sintomas intrusivos agudos (memórias angustiantes, sonhos, flashbacks)", False, 0),
        ("acute_dissociation", "Sintomas dissociativos (entorpecimento, desrealização, amnésia dissociativa)", False, 0),
        ("acute_avoidance", "Esquiva aguda de estímulos associados ao evento traumático", False, 0),
        ("acute_arousal", "Sintomas de excitacao aumentada (distúrbio do sono, irritabilidade, hipervigilância, problemas de concentração, sobressalto)", False, 0),
        ("acute_stress_duration", "A duração da perturbação é de 3 dias a 1 mês após exposição ao trauma", True, 0),
    ],
    "Outro Transtorno da Eliminação Especificado": [
        ("enuresis_repeated", "Eliminação repetida de urina na cama ou roupa, de forma involuntária ou intencional", True, 90),
        ("enuresis_frequency", "Ocorre pelo menos 2x/semana por 3+ meses ou causa sofrimento significativo", False, 90),
        ("enurese_age_5", "Idade cronológica mínima de 5 anos", False, 0),
        ("not_medical_enurese", "Não é devido a efeitos fisiológicos de substância ou condição médica", False, 0),
    ],
    "Outro Transtorno da Personalidade Especificado": [
        ("paranoid_suspicion", "Suspeita generalizada e desconfiança em relação aos outros, interpretando motivos como maliciosos", True, 0),
        ("distrust_loyalty", "Dúvidas infundadas sobre lealdade/confiança de amigos ou parceiros", False, 0),
        ("grudges", "Rancor persistente (não perdoa insultos, desprezos ou ofensas)", False, 0),
        ("threat_overreaction", "Reação exagerada a ameaças percebidas", False, 0),
        ("hidden_meanings", "Percepção de significados ocultos em comentários ou eventos benignos", False, 0),
        ("suspicious_fidelity", "Suspeitas recorrentes e infundadas sobre fidelidade de parceiro", False, 0),
    ],
    "Outro Transtorno de Ansiedade Especificado": [
        ("separation_fear", "Medo ou ansiedade excessiva e inadequada quanto à separação de figuras de apego", True, 30),
        ("separation_worry_loss", "Preocupação persistente com a perda de figuras de apego ou com possível dano a elas", False, 30),
        ("separation_refusal", "Recusa ou relutância em sair de perto das figuras de apego", False, 30),
        ("separation_physical_symptoms", "Sintomas físicos recorrentes (cefaleia, dor abdominal, náusea) quando a separação ocorre ou é antecipada", False, 0),
    ],
    "Outro Transtorno de Sintomas Somáticos Especificado": [
        ("illness_preoccupation", "Preocupação com ter ou adquirir uma doença grave", True, 180),
        ("health_anxiety_elevated", "Nível elevado de ansiedade sobre a saúde", False, 180),
        ("health_checking_behaviors", "Comportamentos excessivos de verificação da saúde (exame corporal, busca de informações médicas)", False, 180),
        ("health_anxiety_6_months", "Preocupação presente por 6+ meses", False, 180),
    ],
    "Outro Transtorno do Espectro da Esquizofrenia Especificado": [
        ("delusions", "Crenças fixas que não mudam diante de evidências contraditórias", True, 30),
        ("non_bizarre_delusions", "Delírios não bizarros (situações que poderiam ocorrer na vida real, como ser seguido ou envenenado)", False, 0),
        ("preserved_functioning", "Funcionamento relativamente preservado apesar dos delírios", False, 0),
        ("social_dysfunction", "Comprometimento do funcionamento social, ocupacional ou acadêmico", False, 0),
    ],
    "Outro Transtorno do Neurodesenvolvimento Especificado": [
        ("social_communication", "Déficit na comunicação socioemocional recíproca (abordagem social anormal, falha em iniciar/manter conversa)", True, 0),
        ("restricted_interests", "Interesses fixos e intensos em tópicos específicos (intensidade ou foco anormais)", False, 0),
        ("repetitive_movements", "Movimentos motores repetitivos ou fala repetitiva (estereotipias, ecolalia)", False, 0),
        ("sensory_sensitivity", "Hiper ou hiporreatividade a estímulos sensoriais ou interesse incomum por aspectos sensoriais do ambiente", False, 0),
        ("routine_insistence", "Insistência em rotinas ou rituais não funcionais (resistência a mudanças)", False, 0),
    ],
    "Outro Transtorno do Sono-Vigília Especificado": [
        ("excessive_sleepiness_7h", "Sonolência excessiva apesar de sono principal de 7+ horas", True, 90),
        ("irresistible_sleep_episodes", "Episódios recorrentes de sono irresistível dentro do mesmo dia", False, 90),
        ("hypersomnia_3x_week", "Hipersonia ocorre 3+ vezes por semana", False, 90),
        ("non_restorative_sleep", "Sono não restaurador apesar de duração adequada", False, 0),
    ],
    ...
    "Transtorno da Comunicação Não Especificado": [
        ("language_acquisition_deficit", "Déficit na aquisição e uso da linguagem em qualquer modalidade (falada, escrita, sinais)", True, 0),
        ("language_comprehension_deficit", "Déficit na compreensão da linguagem (vocabulário reduzido, dificuldade com sentenças complexas)", False, 0),
        ("language_expression_deficit", "Déficit na expressão da linguagem (vocabulário limitado, erros gramaticais, discurso desorganizado)", False, 0),
        ("language_below_age", "As habilidades linguísticas estão substancialmente abaixo do esperado para a idade", False, 0),
    ],
    ...
    "Transtorno de Tique Especificado": [
        ("multiple_motor_tics", "Múltiplos tiques motores e um ou mais tiques vocais presentes em algum momento durante o quadro", True, 365),
        ("vocal_tics", "Presença de tiques vocais (palavras ou sons repetitivos)", True, 365),
        ("tic_onset_before_18", "Início antes dos 18 anos", True, 0),
        ("tic_duration_one_year", "Tiques persistem por mais de 1 ano desde o início dos sintomas", False, 365),
    ],
    ...
    "Transtorno Específico da Aprendizagem Não Especificado": [
        ("reading_accuracy_deficit", "Precisão na leitura de palavras lenta, com esforço e imprecisa", False, 180),
        ("reading_comprehension_deficit", "Dificuldade em compreender o significado do que é lido", False, 180),
        ("spelling_deficit", "Dificuldade em soletrar ou escrever de forma ortograficamente correta", False, 180),
        ("written_expression_deficit", "Dificuldade em organizar pensamentos por escrito (clareza, gramática, estrutura)", False, 180),
        ("math_computation_deficit", "Dificuldade com fatos aritméticos básicos ou cálculo", False, 180),
        ("math_reasoning_deficit", "Dificuldade em raciocínio matemático (conceitos quantitativos, resolução de problemas)", False, 180),
    ],
    ...
    "Transtorno Mental Não Especificado": [
        ("distress_impairment_symptoms", "Sintomas característicos de transtorno mental que causam sofrimento ou prejuízo clinicamente significativo", True, 0),
        ("insufficient_information", "Não há informação suficiente para fazer um diagnóstico mais específico", False, 0),
        ("emergency_context", "Em contextos de emergência onde não é possível determinar se os sintomas são primários ou induzidos", False, 0),
    ],
    ...
    "Transtorno de Déficit de Atenção/Hiperatividade — Apresentação Combinada": [
        ("inattention", "Desatenção persistente com dificuldade em manter foco em tarefas", True, 180),
        ("hyperactivity", "Hiperatividade com excesso de atividade motora inapropriada", True, 180),
        ("impulsivity", "Impulsividade com ações precipitadas sem consideração de consequências", False, 180),
        ("organizational_difficulty", "Dificuldade organizacional com má gestão de tarefas e materiais", False, 180),
        ("forgetfulness", "Esquecimento frequente de atividades diárias e compromissos", False, 180),
    ],
    "Transtorno de Déficit de Atenção/Hiperatividade — Apresentação Predominante com Desatenção": [
        ("inattention", "Desatenção persistente com dificuldade em manter foco em tarefas", True, 180),
        ("hyperactivity", "Hiperatividade com excesso de atividade motora inapropriada", False, 180),
        ("impulsivity", "Impulsividade com ações precipitadas sem consideração de consequências", False, 180),
        ("organizational_difficulty", "Dificuldade organizacional com má gestão de tarefas e materiais", True, 180),
        ("forgetfulness", "Esquecimento frequente de atividades diárias e compromissos", True, 180),
    ],
    "Transtorno de Déficit de Atenção/Hiperatividade — Apresentação Predominante com Hiperatividade": [
        ("inattention", "Desatenção persistente com dificuldade em manter foco em tarefas", False, 180),
        ("hyperactivity", "Hiperatividade com excesso de atividade motora inapropriada", True, 180),
        ("impulsivity", "Impulsividade com ações precipitadas sem consideração de consequências", True, 180),
        ("organizational_difficulty", "Dificuldade organizacional com má gestão de tarefas e materiais", False, 180),
        ("forgetfulness", "Esquecimento frequente de atividades diárias e compromissos", False, 180),
    ],
