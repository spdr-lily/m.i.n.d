"""
⚠️  WARNING: ALL CLINICAL DATA GENERATED BY THIS SCRIPT IS SYNTHETIC.
⚠️  Patients, consultations, symptoms, scale responses, and inferences are
⚠️  procedurally generated for development, testing, and ML demonstration only.
⚠️  No real patient data is used. Do not use in production with real patients.
"""
